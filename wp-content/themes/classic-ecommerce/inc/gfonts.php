...
function classic_ecommerce_custom_styles($custom) {
	//Fonts
	...
	wp_add_inline_style( 'classic-ecommerce-style', $custom );
}
add_action( 'wp_enqueue_scripts', 'classic_ecommerce_custom_styles' );

//Sanitizes Fonts
function classic_ecommerce_sanitize_fonts( $input ) {
	$valid = array(
